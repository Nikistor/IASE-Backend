    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foundation_date', models.IntegerField(blank=True, null=True, verbose_name='Дата основания')),
                ('grp', models.FloatField(blank=True, null=True, verbose_name='Население (млн)')),
                ('climate', models.CharField(blank=True, max_length=255, null=True, verbose_name='Климат')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('companies', models.ManyToManyField(null=True, to='vacancies.company', verbose_name='Города')),
